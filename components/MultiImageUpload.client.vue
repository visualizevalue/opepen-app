<template>
  <div class="multi-image-upload">
    <label>{{ name }}</label>
    <Button v-if="!disabled" type="button" @click="reset" class="small clear">
      <Icon type="trash" />
      <span>Clear</span>
    </Button>
    ...
    >
      ...
      <input
        type="file"
        name="image"
        accept="image/png, image/jpeg, image/gif, image/svg+xml, image/webp, video/mp4, video/webm, model/gltf+json, model/gltf-binary, .gltf, .glb, .html, text/html"
